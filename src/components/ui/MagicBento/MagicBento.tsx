...
const cardData: BentoCardProps[] = [
    ...
    },
    {
        color: "#000000",
        title: "Brasil",
        description: "Nascido e residente em São Paulo",
        label: "Local",
        Icon: MapPinIcon,
    },
    {
        color: "#000000",
        title: "Desenvolvedor",
        description: "Trabalho como desenvolvedor desde 2020",
        label: "Profissão",
        Icon: BriefcaseIcon,
    },
    {
        color: "#000000",
        title: "5 anos+",
        description: "5 anos+ de experiência em desenvolvimento de software.",
        label: "Experiência",
        Icon: SparklesIcon,
    },
    {
        color: "#000000",
        title: "Frontend",
        description: "Desenvolvo interfaces web modernas e responsivas.",
        label: "Frontend",
        Icon: CodeIcon,
    },
    {
        color: "#000000",
        title: "Backend",
        description: "Desenvolvo backend robustos e escaláveis.",
        label: "Backend",
        Icon: ServerIcon,
    },
];
                                ...
                                >
                                    <div className="card__header flex justify-between gap-3 relative text-white">
                                        <span className="card__label text-base flex items-center gap-2">
                                            <card.Icon className="size-4 opacity-50" />
                                            {card.label}
                                        </span>
                                    </div>
